...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HomePage.main_link_title'
        db.alter_column(u'homepage_homepage', 'main_link_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'HomePageRelatedLink.title'
        db.alter_column(u'homepage_homepagerelatedlink', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'HomePage.main_link_title'
        db.alter_column(u'homepage_homepage', 'main_link_title', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))

        # Changing field 'HomePageRelatedLink.title'
        db.alter_column(u'homepage_homepagerelatedlink', 'title', self.gf('wagtail.wagtailcore.fields.RichTextField')())
    ...
    models = {
        ...
        u'homepage.homepage': {
            ...
            'main_link_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
