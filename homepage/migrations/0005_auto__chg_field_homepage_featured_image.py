...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HomePage.featured_image'
        db.alter_column(u'homepage_homepage', 'featured_image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image']))

    def backwards(self, orm):

        # Changing field 'HomePage.featured_image'
        db.alter_column(u'homepage_homepage', 'featured_image_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['wagtailimages.Image']))
