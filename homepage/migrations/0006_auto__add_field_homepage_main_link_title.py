...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.main_link_title'
        db.add_column(u'homepage_homepage', 'main_link_title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.main_link_title'
        db.delete_column(u'homepage_homepage', 'main_link_title')
