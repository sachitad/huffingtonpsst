...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'homepage_homepagerelatedlink', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['homepage.HomePage'])),
        ))
        db.send_create_signal(u'homepage', ['HomePageRelatedLink'])
        ...
        db.create_table(u'homepage_homepage', (
            ...
            ('main_link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='main_link', null=True, to=orm['wagtailcore.Page'])),
            ('featured_image', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['wagtailimages.Image'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'homepage_homepagerelatedlink')
