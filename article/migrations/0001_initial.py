...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'article_articletag', (
            ...
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'article_articletag_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('modelcluster.fields.ParentalKey')(related_name='tagged_items', to=orm['article.Article'])),
        ))
        ...
        db.create_table(u'article_article', (
            ...
            ('featured_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['wagtailimages.Image'])),
            ('is_blog', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_article', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_top_post', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('custom_redirect_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
    ...
    models = {
        u'article.article': {
            'Meta': {'object_name': 'Article', '_ormbases': [u'wagtailcore.Page']},
            ...
            'custom_redirect_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'featured_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
            'is_article': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_blog': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_top_post': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'article.articletag': {
            ...
            'content_object': ('modelcluster.fields.ParentalKey', [], {'related_name': "'tagged_items'", 'to': u"orm['article.Article']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'article_articletag_items'", 'to': u"orm['taggit.Tag']"})
        },
        u'auth.group': {
        ...
        u'author.author': {
            ...
            'short_bio': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'category.category': {
            'Meta': {'object_name': 'Category', '_ormbases': [u'wagtailcore.Page']},
            u'page_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wagtailcore.Page']", 'unique': 'True', 'primary_key': 'True'}),
            'show_in_sub_menu': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
