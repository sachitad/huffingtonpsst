...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.is_article'
        db.delete_column(u'article_article', 'is_article')

        # Adding field 'Article.is_dirty_post'
        db.add_column(u'article_article', 'is_dirty_post',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.is_article'
        db.add_column(u'article_article', 'is_article',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Article.is_dirty_post'
        db.delete_column(u'article_article', 'is_dirty_post')
    ...
    models = {
        u'article.article': {
            ...
            'is_dirty_post': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
