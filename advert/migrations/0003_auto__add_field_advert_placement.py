...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advert.placement'
        db.add_column(u'advert_advert', 'placement',
                      self.gf('django.db.models.fields.CharField')(default='Side', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advert.placement'
        db.delete_column(u'advert_advert', 'placement')


    models = {
        u'advert.advert': {
            'Meta': {'object_name': 'Advert'},
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['category.Category']", 'symmetrical': 'False'}),
            'custom_redirect_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wagtailimages.Image']"}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'placement': ('django.db.models.fields.CharField', [], {'default': "'Side'", 'max_length': '6'}),
