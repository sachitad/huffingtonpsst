...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Author'
        db.create_table(u'author_author', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('short_bio', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('biography', self.gf('wagtail.wagtailcore.fields.RichTextField')()),
        ...
        db.send_create_signal(u'author', ['Author'])


    def backwards(self, orm):
        # Deleting model 'Author'
        db.delete_table(u'author_author')
