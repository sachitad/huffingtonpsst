...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.is_active'
        db.delete_column(u'video_video', 'is_active')


    def backwards(self, orm):
        # Adding field 'Video.is_active'
        db.add_column(u'video_video', 'is_active',
    ...
    models = {
        ...
        u'video.video': {
            'Meta': {'object_name': 'Video', '_ormbases': [u'wagtailcore.Page']},
