...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.bio'
        db.alter_column(u'comment_comment', 'bio', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Comment.bio'
        db.alter_column(u'comment_comment', 'bio', self.gf('django.db.models.fields.CharField')(default=1, max_length=255))
