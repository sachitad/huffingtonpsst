...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ArticleRelatedComments'
        db.create_table(u'comment_articlerelatedcomments', (
            ...
            ('article', self.gf('modelcluster.fields.ParentalKey')(related_name='related_comments', to=orm['article.Article'])),
        ))
        db.send_create_signal(u'comment', ['ArticleRelatedComments'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ArticleRelatedComments'
        db.delete_table(u'comment_articlerelatedcomments')
    ...
    models = {
        ...
        u'author.author': {
            'Meta': {'object_name': 'Author', '_ormbases': [u'wagtailcore.Page']},
        ...
        u'comment.articlerelatedcomments': {
            'Meta': {'ordering': "['sort_order']", 'object_name': 'ArticleRelatedComments'},
            'article': ('modelcluster.fields.ParentalKey', [], {'related_name': "'related_comments'", 'to': u"orm['article.Article']"}),
