...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.show_in_sub_menu'
        db.add_column(u'category_category', 'show_in_sub_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.show_in_sub_menu'
        db.delete_column(u'category_category', 'show_in_sub_menu')
